package net.lumi_noble.rpgskillable_fork.client.screen;

import net.lumi_noble.rpgskillable_fork.Config;
import net.lumi_noble.rpgskillable_fork.RpgSkillable;
import net.lumi_noble.rpgskillable_fork.client.screen.button.SkillButton;
...
public class SkillScreen extends Screen {
	...
	public static final ResourceLocation RESOURCES = new ResourceLocation(RpgSkillable.MOD_ID, "textures/gui/skill_screen.png");
