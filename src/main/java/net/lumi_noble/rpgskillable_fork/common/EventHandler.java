package net.lumi_noble.rpgskillable_fork.common;
...
import net.lumi_noble.rpgskillable_fork.common.capabilities.SkillCapability;
import net.lumi_noble.rpgskillable_fork.common.capabilities.SkillModel;
import net.lumi_noble.rpgskillable_fork.common.capabilities.SkillProvider;
	...
	public void onAttachCapabilities(AttachCapabilitiesEvent<Entity> event) {
		...
		if (event.getObject() instanceof Player) {
			...
			if (!event.getObject().getCapability(SkillCapability.SKILL_MODEL).isPresent()) {
				event.addCapability(new ResourceLocation(RpgSkillable.MOD_ID, "cap_skills"), provider);
			}
		}
	}
